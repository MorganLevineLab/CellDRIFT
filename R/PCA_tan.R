#' @title PCA_tan
#'
#' @description The PCA object allowing prediction and mapping of tan PCs in new data.
#'
#' @format A list object as defined by the output of calling prcomp([tan-module-CpG-Mat])
#' \describe{
